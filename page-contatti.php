                ...
                <form class="contact-form" method="post" action="">
                    <div class="contact-form__row">
                        <div class="contact-form__field">
                            ...
                            <input type="text" id="cf-nome" name="nome" placeholder="Paola" required>
                        </div>
                        <div class="contact-form__field">
                            <label for="cf-cognome">Cognome</label>
                            <input type="text" id="cf-cognome" name="cognome" placeholder="Rossi" required>
                        </div>
                    </div>
                    <div class="contact-form__field">
                        <label for="cf-email">e-mail</label>
                        <input type="email" id="cf-email" name="email" placeholder="paolarossi@gmail.com" required>
                    </div>
                    <div class="contact-form__field">
